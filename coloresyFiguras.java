 ...
 * @author julio
 */
public class coloresyFiguras extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(coloresyFiguras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new coloresyFiguras().setVisible(true);
            }
        });
    }
    ...
    private void setVisibe(boolean b) {
